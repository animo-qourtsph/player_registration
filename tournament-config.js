window.TOURNAMENT_CONFIG = {
  ...
  registrationTypes: [
    { id: "pair", label: "Register with My Partner", description: "I’ll enter both players’ details now.", enabled: true },
    { id: "individual", label: "Register Individually", description: "Register now and be matched later if organizer rules allow.", enabled: false },
    { id: "invite", label: "Invite My Partner", description: "I’ll register first and my partner will complete their details later.", enabled: true },
    { id: "existing", label: "Link Existing Registration", description: "My partner has already registered; I’ll link their registration reference.", enabled: true }
  ],
  ...
  paymentMethods: [
    { id:"gcash", label:"GCash", enabled:false, accountName:"[GCASH_ACCOUNT_NAME]", accountNumber:"[GCASH_ACCOUNT]", qrAsset:"[GCASH_QR_ASSET]", instructions:"[GCASH_PAYMENT_INSTRUCTIONS]" },
    { id:"paymaya", label:"PayMaya", enabled:false, accountName:"[PAYMAYA_ACCOUNT_NAME]", accountNumber:"[PAYMAYA_ACCOUNT]", qrAsset:"[PAYMAYA_QR_ASSET]", instructions:"[PAYMAYA_PAYMENT_INSTRUCTIONS]" },
    { id:"maribank", label:"MariBank", enabled:false, accountName:"[MARIBANK_ACCOUNT_NAME]", accountNumber:"[MARIBANK_ACCOUNT]", qrAsset:"[MARIBANK_QR_ASSET]", instructions:"[MARIBANK_PAYMENT_INSTRUCTIONS]" },
    { id:"bdo", label:"BDO", enabled:false, accountName:"[BDO_ACCOUNT_NAME]", accountNumber:"[BDO_ACCOUNT]", qrAsset:"[BDO_QR_ASSET]", instructions:"[BDO_PAYMENT_INSTRUCTIONS]" },
    { id:"bpi", label:"BPI", enabled:false, accountName:"[BPI_ACCOUNT_NAME]", accountNumber:"[BPI_ACCOUNT]", qrAsset:"[BPI_QR_ASSET]", instructions:"[BPI_PAYMENT_INSTRUCTIONS]" }
  ],
  waiver: {
  ...
  heroCarousel: {
    autoplayMs: 6500,
    slides: [
      { eyebrow:"Official registration portal", headline:"ANIMO PICKLEBALL\nCUP 2026", body:"Open tournament. One division per player. October 17, 2026 · Pampanga Pickleball Center.", image:"", imageAlt:"", imagePosition:"center", contentPosition:"center", primaryCtaLabel:"Register Now", secondaryCtaLabel:"Tournament Details", showSecondaryCta:false },
      { eyebrow:"Level verification", headline:"DUPR or organizer review.\nEveryone has a path.", body:"Have DUPR? Enter your rating and upload proof. No DUPR yet? Submit your club and playing history so the tournament committee can classify you.", image:"", imageAlt:"", imagePosition:"center", contentPosition:"center", primaryCtaLabel:"Register Now", secondaryCtaLabel:"Tournament Details", showSecondaryCta:false },
      { eyebrow:"Official tournament jersey", headline:"Your name.\nYour jersey.", body:"Enter the exact name you want printed on the back of your official tournament jersey.", image:"", imageAlt:"", imagePosition:"center", contentPosition:"center", primaryCtaLabel:"Register Now", secondaryCtaLabel:"Tournament Details", showSecondaryCta:false }
    ]
  }
};
