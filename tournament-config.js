window.TOURNAMENT_CONFIG = {
  ...
  registrationTypes: [
    ...
    { id: "invite", label: "Invite My Partner", description: "I’ll register first and my partner will complete their details later.", enabled: false },
    { id: "existing", label: "Link Existing Registration", description: "My partner has already registered; I’ll link their registration reference.", enabled: false }
  ],
